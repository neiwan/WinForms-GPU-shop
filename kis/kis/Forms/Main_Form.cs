...
namespace kis
{
    public partial class Main_Form : Form
    {
        ...
        // TODO: добавить обработчик исключения ввода стринга в интовые поля
        // TODO: добавить реализацию кнопки отчетов и всякая хуйня там
        // TODO: добавить кнопку сигн ин и реализацию к ней
        // TODO: добавить обработку исключений для сигн ина
        // TODO: добавить реализацию к кнопке статс и всякую хуйню там сделать
    }
